...
function Home() {
    ...
    const url=`https://api.flickr.com/services/rest/?format=json&method=flickr.photos.search&api_key=${flickrapi}&safe_search=1&content_type=1&per_page=20&jsoncallback=?`
